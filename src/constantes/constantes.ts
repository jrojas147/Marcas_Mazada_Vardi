const nombreCliente = "Mazda Vardí";

export const Constantes = {
    nombreCliente: "Mazda Vardí",
    webAliado: "https://www.mazdavardi.com.co/",
    ...
    clienteVardi: './assets/img/vardi.png',
    clienteMazda: './assets/img/mazda.png',
